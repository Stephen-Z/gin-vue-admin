<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="主题名" prop="themeName" width="120" />
        <el-table-column align="left" label="用户角色" prop="userRoles" width="120" />
        <el-table-column align="left" label="登录页logo" prop="loginViewLogo" width="120" />
        <el-table-column align="left" label="系统logo" prop="systemLogo" width="120" />
        <el-table-column align="left" label="系统名称" prop="systemName" width="120" />
        <el-table-column align="left" label="背景轮播图" prop="backgroundPhoto" width="120" />
        <el-table-column align="left" label="是否默认主题" prop="isOrNoDefaultTheme" width="120">
            <template #default="scope">{{ formatBoolean(scope.row.isOrNoDefaultTheme) }}</template>
        </el-table-column>
        <el-table-column align="left" label="操作">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateThemeFunc(scope.row)">变更</el-button>
...
const getTableData = async() => {
  const table = await getThemeList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
