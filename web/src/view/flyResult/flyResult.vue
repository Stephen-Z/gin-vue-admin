  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        >
          <template #default="scope">{{
            convertTableValue(scope.row.downloaded, downloadedList)
          }}</template>
        </el-table-column>
        <el-table-column align="left" label="操作">
          <template #default="scope">
            <el-button
              ...
              icon="edit"
              class="table-button"
              @click="updateFlyResultFunc(scope.row)"
              >变更</el-button
            >
            <el-button
              type="primary"
    ...
    >
      ...
      >
        ...
        <el-form-item label="序号:" prop="fileOrder">
          <el-input
            v-model.number="formData.fileOrder"
            :clearable="true"
            placeholder="请输入"
          />
        </el-form-item>
...
const getTableData = async () => {
  const table = await getFlyResultList({
    page: page.value,
