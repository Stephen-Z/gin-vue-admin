        ...
        <el-table-column align="left" label="操作">
          <template #default="scope">
            <el-button
              ...
              icon="edit"
              class="table-button"
              @click="updateNestExecRecordFunc(scope.row)"
              >变更</el-button
            >
            <el-button
              type="primary"
    ...
    >
      ...
      >
        ...
        <el-form-item label="飞行秒:" prop="flyInSecond">
          <el-input
            v-model.number="formData.flyInSecond"
            :clearable="true"
            placeholder="请输入"
          />
        </el-form-item>
...
const getTableData = async () => {
  const table = await getNestExecRecordList({
    page: page.value,
